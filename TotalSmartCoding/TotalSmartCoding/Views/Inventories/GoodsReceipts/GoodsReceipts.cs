    ...
    public partial class GoodsReceipts : BaseView
    {
        ...
        private void ViewDetails_ListChanged(object sender, ListChangedEventArgs e)
        {
            if (e.ListChangedType == ListChangedType.ItemAdded || e.ListChangedType == ListChangedType.ItemDeleted || e.ListChangedType == ListChangedType.Reset)
            {
                ...
                this.gridexPalletDetails.Columns["Pallet" + CommonExpressions.PropertyName<GoodsReceiptDetailDTO>(p => p.PrimaryReference)].Visible = this.goodsReceiptViewModel.PickupID == null && this.goodsReceiptViewModel.GoodsIssueID == null && this.goodsReceiptViewModel.SalesReturnID == null && this.goodsReceiptViewModel.WarehouseAdjustmentID == null;
                this.gridexPalletDetails.Columns["Pallet" + CommonExpressions.PropertyName<GoodsReceiptDetailDTO>(p => p.PrimaryEntryDate)].Visible = this.goodsReceiptViewModel.PickupID == null && this.goodsReceiptViewModel.GoodsIssueID == null && this.goodsReceiptViewModel.SalesReturnID == null && this.goodsReceiptViewModel.WarehouseAdjustmentID == null;

                this.gridexCartonDetails.Columns["Carton" + CommonExpressions.PropertyName<GoodsReceiptDetailDTO>(p => p.PrimaryReference)].Visible = this.goodsReceiptViewModel.PickupID == null && this.goodsReceiptViewModel.GoodsIssueID == null && this.goodsReceiptViewModel.SalesReturnID == null && this.goodsReceiptViewModel.WarehouseAdjustmentID == null;
                this.gridexCartonDetails.Columns["Carton" + CommonExpressions.PropertyName<GoodsReceiptDetailDTO>(p => p.PrimaryEntryDate)].Visible = this.goodsReceiptViewModel.PickupID == null && this.goodsReceiptViewModel.GoodsIssueID == null && this.goodsReceiptViewModel.SalesReturnID == null && this.goodsReceiptViewModel.WarehouseAdjustmentID == null;
            }
        }
