                        ...
                        if (excelDataRow["WarehouseCode"] != null && excelDataRow["WarehouseCode"].ToString().Trim() != "")
                        {
                            ...
                            if (warehouseBase != null && warehouseBase.LocationID == this.forecastViewModel.ForecastLocationID)
                            {
                                ...
                                if (commodityBase != null)
                                {
                                    ...
                                    if (decimal.TryParse(excelDataRow["CurrentMonth"].ToString(), out decimalValue)) { if (this.forecastViewModel.QuantityVersusVolume == 0) { forecastDetailDTO.Quantity = decimalValue; forecastDetailDTO.LineVolume = decimalValue * commodityBase.PackageVolume; } else { forecastDetailDTO.LineVolume = decimalValue; forecastDetailDTO.Quantity = decimalValue / commodityBase.PackageVolume; } } else exceptionTable.AddException(new string[] { "Type mismatch; number value required", "Column current month: " + excelDataRow["CurrentMonth"].ToString() });
                                    if (decimal.TryParse(excelDataRow["NextMonth"].ToString(), out decimalValue)) { if (this.forecastViewModel.QuantityVersusVolume == 0) { forecastDetailDTO.QuantityM1 = decimalValue; forecastDetailDTO.LineVolumeM1 = decimalValue * commodityBase.PackageVolume; } else { forecastDetailDTO.LineVolumeM1 = decimalValue; forecastDetailDTO.QuantityM1 = decimalValue / commodityBase.PackageVolume; } } else exceptionTable.AddException(new string[] { "Type mismatch; number value required", "Column next month: " + excelDataRow["NextMonth"].ToString() });
                                    if (decimal.TryParse(excelDataRow["NextTwoMonth"].ToString(), out decimalValue)) { if (this.forecastViewModel.QuantityVersusVolume == 0) { forecastDetailDTO.QuantityM2 = decimalValue; forecastDetailDTO.LineVolumeM2 = decimalValue * commodityBase.PackageVolume; } else { forecastDetailDTO.LineVolumeM2 = decimalValue; forecastDetailDTO.QuantityM2 = decimalValue / commodityBase.PackageVolume; } } else exceptionTable.AddException(new string[] { "Type mismatch; number value required", "Column next two month: " + excelDataRow["NextTwoMonth"].ToString() });
                                    if (decimal.TryParse(excelDataRow["NextThreeMonth"].ToString(), out decimalValue)) { if (this.forecastViewModel.QuantityVersusVolume == 0) { forecastDetailDTO.QuantityM3 = decimalValue; forecastDetailDTO.LineVolumeM3 = decimalValue * commodityBase.PackageVolume; } else { forecastDetailDTO.LineVolumeM3 = decimalValue; forecastDetailDTO.QuantityM3 = decimalValue / commodityBase.PackageVolume; } } else exceptionTable.AddException(new string[] { "Type mismatch; number value required", "Column next three month: " + excelDataRow["NextThreeMonth"].ToString() });
