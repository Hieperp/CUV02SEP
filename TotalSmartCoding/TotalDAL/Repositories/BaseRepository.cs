    ...
    public class BaseRepository : IBaseRepository
    {
        ...
        public void UpdateDatabases(bool restoreProcedures)
        {
            ...
            if (!this.totalSmartCodingEntities.ColumnExists("Reports", "OptionBoxIDs"))
            {
                ...
                this.ExecuteStoreCommand("SET IDENTITY_INSERT Reports ON  INSERT INTO Reports (ReportID, ReportUniqueID, ReportGroupID, ReportGroupName, ReportName, ReportURL, ReportTabPageIDs, OptionBoxIDs, ReportTypeID, SerialID, Remarks) VALUES (" + (int)GlobalEnums.ReportID.CurrentWarehouseFilter + ", " + (int)GlobalEnums.ReportID.CurrentWarehouseFilter + ", 8, '1.INVENTORY REPORTS', N'Current Warehouse Filters', N'WarehouseForecastFilters', N'" + reportTabPageIDs + "', N'" + optionBoxIDs + "', " + (int)GlobalEnums.ReportTypeID.WarehouseForecast + ", 837, N'')      SET IDENTITY_INSERT Reports OFF ", new ObjectParameter[] { });
