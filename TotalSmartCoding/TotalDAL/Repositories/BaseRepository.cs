    ...
    public class BaseRepository : IBaseRepository
    {
        ...
        public void UpdateDatabases(bool restoreProcedures)
        {
            ...
            if (!this.totalSmartCodingEntities.ColumnExists("Reports", "ReportTabPageIDs"))
            {
                ...
                this.ExecuteStoreCommand("SET IDENTITY_INSERT Reports ON  INSERT INTO Reports (ReportID, ReportUniqueID, ReportGroupID, ReportGroupName, ReportName, ReportURL, ReportTabPageIDs, ReportTypeID, SerialID, Remarks) VALUES (" + (int)GlobalEnums.ReportUniqueID.GoodsReceiptPivot + ", " + (int)GlobalEnums.ReportUniqueID.GoodsReceiptPivot + ", 1, 'GOODS RECEIPT PIVOT REPORTS', N'Goods receipt pivot report', N'GoodsIssuePivot', N'" + reportTabPageIDs + "', " + (int)GlobalEnums.ReportTypeID.GoodsReceiptPivot + ", 1, N'')      SET IDENTITY_INSERT Reports OFF ", new ObjectParameter[] { });
                this.ExecuteStoreCommand("SET IDENTITY_INSERT Reports ON  INSERT INTO Reports (ReportID, ReportUniqueID, ReportGroupID, ReportGroupName, ReportName, ReportURL, ReportTabPageIDs, ReportTypeID, SerialID, Remarks) VALUES (" + (int)GlobalEnums.ReportUniqueID.ProductionReceiptPivot + ", " + (int)GlobalEnums.ReportUniqueID.ProductionReceiptPivot + ", 1, 'GOODS RECEIPT PIVOT REPORTS', N'Production receipt pivot report', N'GoodsIssuePivot', N'" + reportTabPageIDs + "', " + (int)GlobalEnums.ReportTypeID.GoodsReceiptPivot + ", 2, N'')      SET IDENTITY_INSERT Reports OFF ", new ObjectParameter[] { });
                this.ExecuteStoreCommand("SET IDENTITY_INSERT Reports ON  INSERT INTO Reports (ReportID, ReportUniqueID, ReportGroupID, ReportGroupName, ReportName, ReportURL, ReportTabPageIDs, ReportTypeID, SerialID, Remarks) VALUES (" + (int)GlobalEnums.ReportUniqueID.TransferReceiptPivot + ", " + (int)GlobalEnums.ReportUniqueID.TransferReceiptPivot + ", 1, 'GOODS RECEIPT PIVOT REPORTS', N'Transfer receipt pivot report', N'GoodsIssuePivot', N'" + reportTabPageIDs + "," + ((int)GlobalEnums.ReportTabPageID.TabPageWarehouseIssues).ToString() + "', " + (int)GlobalEnums.ReportTypeID.GoodsReceiptPivot + ", 3, N'')      SET IDENTITY_INSERT Reports OFF ", new ObjectParameter[] { });
                this.ExecuteStoreCommand("SET IDENTITY_INSERT Reports ON  INSERT INTO Reports (ReportID, ReportUniqueID, ReportGroupID, ReportGroupName, ReportName, ReportURL, ReportTabPageIDs, ReportTypeID, SerialID, Remarks) VALUES (" + (int)GlobalEnums.ReportUniqueID.AdjustmentReceiptPivot + ", " + (int)GlobalEnums.ReportUniqueID.AdjustmentReceiptPivot + ", 1, 'GOODS RECEIPT PIVOT REPORTS', N'Adjustment receipt pivot report', N'GoodsIssuePivot', N'" + reportTabPageIDs + "," + ((int)GlobalEnums.ReportTabPageID.TabPageWarehouseAdjustmentTypes).ToString() + "', " + (int)GlobalEnums.ReportTypeID.GoodsReceiptPivot + ", 4, N'')      SET IDENTITY_INSERT Reports OFF ", new ObjectParameter[] { });

                this.ExecuteStoreCommand("SET IDENTITY_INSERT Reports ON  INSERT INTO Reports (ReportID, ReportUniqueID, ReportGroupID, ReportGroupName, ReportName, ReportURL, ReportTabPageIDs, ReportTypeID, SerialID, Remarks) VALUES (" + (int)GlobalEnums.ReportUniqueID.GoodsIssuePivot + ", " + (int)GlobalEnums.ReportUniqueID.GoodsIssuePivot + ", 10, 'GOODS ISSUE PIVOT REPORTS', N'Goods issue pivot report', N'GoodsIssuePivot', N'" + reportTabPageIDs + "', " + (int)GlobalEnums.ReportTypeID.GoodsIssuePivot + ", 11, N'')      SET IDENTITY_INSERT Reports OFF ", new ObjectParameter[] { });
                this.ExecuteStoreCommand("SET IDENTITY_INSERT Reports ON  INSERT INTO Reports (ReportID, ReportUniqueID, ReportGroupID, ReportGroupName, ReportName, ReportURL, ReportTabPageIDs, ReportTypeID, SerialID, Remarks) VALUES (" + (int)GlobalEnums.ReportUniqueID.SalesIssuePivot + ", " + (int)GlobalEnums.ReportUniqueID.SalesIssuePivot + ", 10, 'GOODS ISSUE PIVOT REPORTS', N'Sales issue pivot report', N'GoodsIssuePivot', N'" + reportTabPageIDs + "," + ((int)GlobalEnums.ReportTabPageID.TabPageCustomers).ToString() + "', " + (int)GlobalEnums.ReportTypeID.GoodsIssuePivot + ", 12, N'')      SET IDENTITY_INSERT Reports OFF ", new ObjectParameter[] { });
                this.ExecuteStoreCommand("SET IDENTITY_INSERT Reports ON  INSERT INTO Reports (ReportID, ReportUniqueID, ReportGroupID, ReportGroupName, ReportName, ReportURL, ReportTabPageIDs, ReportTypeID, SerialID, Remarks) VALUES (" + (int)GlobalEnums.ReportUniqueID.TransferIssuePivot + ", " + (int)GlobalEnums.ReportUniqueID.TransferIssuePivot + ", 10, 'GOODS ISSUE PIVOT REPORTS', N'Transfer issue pivot report', N'GoodsIssuePivot', N'" + reportTabPageIDs + "," + ((int)GlobalEnums.ReportTabPageID.TabPageWarehouseReceipts).ToString() + "', " + (int)GlobalEnums.ReportTypeID.GoodsIssuePivot + ", 13, N'')      SET IDENTITY_INSERT Reports OFF ", new ObjectParameter[] { });
                this.ExecuteStoreCommand("SET IDENTITY_INSERT Reports ON  INSERT INTO Reports (ReportID, ReportUniqueID, ReportGroupID, ReportGroupName, ReportName, ReportURL, ReportTabPageIDs, ReportTypeID, SerialID, Remarks) VALUES (" + (int)GlobalEnums.ReportUniqueID.AdjustmentIssuePivot + ", " + (int)GlobalEnums.ReportUniqueID.AdjustmentIssuePivot + ", 10, 'GOODS ISSUE PIVOT REPORTS', N'Adjustment issue pivot report', N'GoodsIssuePivot', N'" + reportTabPageIDs + "," + ((int)GlobalEnums.ReportTabPageID.TabPageWarehouseAdjustmentTypes).ToString() + "', " + (int)GlobalEnums.ReportTypeID.GoodsIssuePivot + ", 14, N'')      SET IDENTITY_INSERT Reports OFF ", new ObjectParameter[] { });
            }
