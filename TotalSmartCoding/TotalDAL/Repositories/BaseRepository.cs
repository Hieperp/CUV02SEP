...
namespace TotalDAL.Repositories
{
    public class BaseRepository : IBaseRepository
    {
        ...
        private void InitReports()
        {
            ...
            this.ExecuteStoreCommand("SET IDENTITY_INSERT Reports ON  INSERT INTO Reports (ReportID, ReportUniqueID, ReportGroupID, ReportGroupName, ReportName, ReportURL, ReportTabPageIDs, OptionBoxIDs, ReportTypeID, SerialID, Remarks) VALUES (" + (int)GlobalEnums.ReportID.OldAndSlowMoving + ", " + (int)GlobalEnums.ReportID.OldAndSlowMoving + ", 8, '1.INVENTORY REPORTS', N'Old & Slow Moving Items', N'WarehouseForecastPivots', N'" + reportTabPageIDs + "', N'" + optionBoxIDs + "', " + (int)GlobalEnums.ReportTypeID.WarehouseForecast + ", 869, N'')      SET IDENTITY_INSERT Reports OFF ", new ObjectParameter[] { });
