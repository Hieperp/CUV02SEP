        ...
        public void UpdateDatabases(bool restoreProcedures)
        {
            ...
            if (!this.totalSmartCodingEntities.TableExists("SalesReturns"))
            {
                ...
                this.ExecuteStoreCommand(@"CREATE TABLE [dbo].[SalesReturns](
                                                    ...
                                                    ALTER TABLE [dbo].[SalesReturns]  WITH CHECK ADD  CONSTRAINT [FK_SalesReturns_Warehouses] FOREIGN KEY([WarehouseID])
                                                    REFERENCES [dbo].[Warehouses] ([WarehouseID])


                                                    ALTER TABLE [dbo].[SalesReturns] CHECK CONSTRAINT [FK_SalesReturns_Warehouses]
            ...
            if (myExists == 0)
            {
                //this.ExecuteStoreCommand("DELETE FROM AccessControls WHERE NMVNTaskID = " + (int)GlobalEnums.NmvnTaskID.SalesReturns, new ObjectParameter[] { });
                //this.ExecuteStoreCommand("DELETE FROM UserGroupControls WHERE ModuleDetailID = " + (int)GlobalEnums.NmvnTaskID.SalesReturns, new ObjectParameter[] { });
                //this.ExecuteStoreCommand("DELETE FROM ModuleDetails WHERE ModuleDetailID = " + (int)GlobalEnums.NmvnTaskID.SalesReturns, new ObjectParameter[] { });

                this.ExecuteStoreCommand("INSERT INTO ModuleDetails (ModuleDetailID, ModuleID, Code, Name, FullName, Actions, Controller, LastOpen, SerialID, ImageIndex, InActive, ControlTypeID) VALUES(" + (int)GlobalEnums.NmvnTaskID.SalesReturns + ", 6, 'Sales Returns', 'Sales Returns', '', '#', 'LOGISTICS ADMIN', 1, 80, 1, 0, 1) ", new ObjectParameter[] { });
