...
namespace TotalDAL.Helpers.SqlProgrammability.Productions
{
    public class Batch
    {
        ...
        private void GetBatchIndexes()
        {
            ...
            queryString = queryString + "                   Batches.NextPackNo, Batches.NextCartonNo, Batches.NextPalletNo, Batches.FinalCartonNo, Batches.AutoBarcode, Batches.Description, Batches.Remarks, Batches.CreatedDate, Batches.EditedDate, Batches.IsDefault, Batches.InActive " + "\r\n";
