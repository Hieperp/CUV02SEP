...
namespace TotalDAL.Helpers.SqlProgrammability.Generals
{
    public class UserGroupControl
    {
        ...
        private void GetUserGroupControls()
        {
            ...
            queryString = queryString + "       WHERE       UserGroupControls.ModuleDetailID NOT IN (" + (int)GlobalEnums.NmvnTaskID.Warehouses + "," + (int)GlobalEnums.NmvnTaskID.Warehouses + ")" + "\r\n"; //HARD CODE HERE: TO EXCLUDE: WAREHOUSE + WAREHOUSE FROM THE CONTROL LIST
