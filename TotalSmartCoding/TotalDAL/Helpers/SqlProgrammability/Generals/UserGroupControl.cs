...
namespace TotalDAL.Helpers.SqlProgrammability.Generals
{
    public class UserGroupControl
    {
        ...
        private void GetUserGroupControls()
        {
            ...
            queryString = queryString + "       WHERE       UserGroupControls.ModuleDetailID NOT IN (" + (int)GlobalEnums.NmvnTaskID.Territories + "," + (int)GlobalEnums.NmvnTaskID.Warehouses + ")" + "\r\n"; //HARD CODE HERE: TO EXCLUDE: TERRITORIES + WAREHOUSE FROM THE CONTROL LIST
