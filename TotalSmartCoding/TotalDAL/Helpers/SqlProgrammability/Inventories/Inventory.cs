...
namespace TotalDAL.Helpers.SqlProgrammability.Inventories
{
    public class Inventory
    {
        ...
        {
            string queryString = this.DEFINEHeader(true, 1).Replace("@FromDate DateTime, ", "").Replace("@LocalFromDate DateTime, ", "").Replace("SET @LocalFromDate = @FromDate", "");
            ...
            queryString = queryString + "       INSERT INTO @WarehouseForecasts         EXEC WarehouseJournals " + this.DEFINEParameter(true, 1).Replace("FromDate", "ToDate") + "\r\n";
