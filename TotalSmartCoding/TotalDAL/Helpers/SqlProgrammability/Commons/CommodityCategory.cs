...
namespace TotalDAL.Helpers.SqlProgrammability.Commons
{
    public class CommodityCategory
    {
        ...
        private void CommodityCategorySaveRelative()
        {
            ...
            queryString = queryString + "               INSERT INTO CommodityCategoryCommodityCategories (CommodityCategoryID, CommodityCategoryID, CommodityCategoryTaskID, EntryDate, Remarks, InActive) " + "\r\n";
            queryString = queryString + "               SELECT      CommodityCategoryID, 82 AS CommodityCategoryID, " + (int)GlobalEnums.NmvnTaskID.DeliveryAdvices + " AS CommodityCategoryTaskID, GETDATE(), '', 0 FROM CommodityCategories WHERE CommodityCategoryID = @EntityID AND CommodityCategoryCategoryID IN (4, 5, 7, 9, 10, 11, 12) " + "\r\n";
