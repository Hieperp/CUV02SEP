...
namespace TotalDAL.Helpers.SqlProgrammability.Commons
{
    public class AccessControl
    {
        ...
        private void GetUserOrganizationalUnit()
        {
            ...
            queryString = queryString + "       SELECT TOP 1 Users.UserID, Users.FirstName, Users.LastName, Users.UserName, Users.SkypeName, Users.IsDatabaseAdmin, OrganizationalUnitUsers.OrganizationalUnitID FROM Users INNER JOIN OrganizationalUnitUsers ON Users.UserID = OrganizationalUnitUsers.UserID WHERE ({ fn UCASE(Users.SkypeName) } = { fn UCASE(@UserName) }) AND OrganizationalUnitUsers.InActive = 0 " + "\r\n";
