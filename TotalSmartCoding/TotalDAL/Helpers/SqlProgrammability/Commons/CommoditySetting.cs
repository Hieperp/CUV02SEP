...
namespace TotalDAL.Helpers.SqlProgrammability.Commons
{
    public class CommoditySetting
    {
        ...
        private void GetCommoditySettingIndexes()
        {
            ...
            queryString = queryString + "       SELECT  CommoditySettingID, MIN(Commodities.CommodityID) AS CommodityID, MIN(Commodities.Code) AS CommodityCode, MIN(Commodities.Name) AS CommodityName, SUM(LowDSI1) AS LowDSI1, SUM(HighDSI1) AS HighDSI1, SUM(AlertDSI1) AS AlertDSI1, SUM(LowDSI2) AS LowDSI2, SUM(HighDSI2) AS HighDSI2, SUM(AlertDSI2) AS AlertDSI2, SUM(LowDSI3) AS LowDSI3, SUM(HighDSI3) AS HighDSI3, SUM(AlertDSI3) AS AlertDSI3, SUM(LowDSI4) AS LowDSI4, SUM(HighDSI4) AS HighDSI4, SUM(AlertDSI4) AS AlertDSI4 " + "\r\n";
            ...
            queryString = queryString + "               ) AS ABC INNER JOIN Commodities ON ABC.CommodityID = Commodities.CommodityID " + "\r\n";
