...
namespace TotalDAL.Helpers.SqlProgrammability.Commons
{
    public class Territory
    {
        ...
        private void TerritorySaveRelative()
        {
            ...
            queryString = queryString + "               INSERT INTO TerritoryTerritories (TerritoryID, TerritoryID, TerritoryTaskID, EntryDate, Remarks, InActive) " + "\r\n";
            queryString = queryString + "               SELECT      TerritoryID, 82 AS TerritoryID, " + (int)GlobalEnums.NmvnTaskID.DeliveryAdvices + " AS TerritoryTaskID, GETDATE(), '', 0 FROM Territories WHERE TerritoryID = @EntityID AND TerritoryCategoryID IN (4, 5, 7, 9, 10, 11, 12) " + "\r\n";
