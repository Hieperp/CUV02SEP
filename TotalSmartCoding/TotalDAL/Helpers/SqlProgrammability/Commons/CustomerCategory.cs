...
namespace TotalDAL.Helpers.SqlProgrammability.Commons
{
    public class CustomerCategory
    {
        ...
        private void CustomerCategorySaveRelative()
        {
            ...
            queryString = queryString + "               INSERT INTO CustomerCategoryCustomerCategories (CustomerCategoryID, CustomerCategoryID, CustomerCategoryTaskID, EntryDate, Remarks, InActive) " + "\r\n";
            queryString = queryString + "               SELECT      CustomerCategoryID, 82 AS CustomerCategoryID, " + (int)GlobalEnums.NmvnTaskID.DeliveryAdvices + " AS CustomerCategoryTaskID, GETDATE(), '', 0 FROM CustomerCategories WHERE CustomerCategoryID = @EntityID AND CustomerCategoryCategoryID IN (4, 5, 7, 9, 10, 11, 12) " + "\r\n";
