...
namespace TotalCore.Repositories.Sales
{
    ...
    public interface IDeliveryAdviceAPIRepository : IGenericAPIRepository
    {
        ...
        List<PendingSalesOrderDetail> GetPendingSalesOrderDetails(int? locationID, int? deliveryAdviceID, int? salesOrderID, int? customerID, string salesOrderDetailIDs, bool isReadonly);
    }
