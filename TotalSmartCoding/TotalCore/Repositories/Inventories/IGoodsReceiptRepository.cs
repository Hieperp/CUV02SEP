...
namespace TotalCore.Repositories.Inventories
{
    ...
    public interface IGoodsReceiptAPIRepository : IGenericAPIRepository
    {
        ...
        List<PendingGoodsIssueTransferDetail> GetPendingGoodsIssueTransferDetails(int? locationID, int? goodsReceiptID, int? pickupID, int? warehouseID, string pickupDetailIDs, bool isReadonly);
        ...
        List<GoodsReceiptDetailAvailable> GetGoodsReceiptDetailAvailables(int? locationID, int? warehouseID, int? commodityID, string commodityIDs, int? batchID, string goodsReceiptDetailIDs);
    }
